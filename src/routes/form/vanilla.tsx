...
export const Route = createFileRoute('/form/vanilla')({
...
function VanillaForm() {
  ...
  const hasEmailError = (email?: string): false | string => {
    if (!email) return 'Email is required'
    return /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}$/i.test(email) ? false : 'Invalid email format'
  }
  ...
  const validateForm = (): boolean => {
    ...
    const emailError = hasEmailError(formData.email)
    if (emailError) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      console.log('Form data submitted (Vanilla):', formData)
      ...
      <div className="max-w-2xl mx-auto px-6 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold mb-4">
            <span className="text-red-400">Vanilla</span> Form Validation
          </h1>
          <p className="text-xl text-gray-400">
            Manual validation with React state and event handlers
          </p>
        </div>
          ...
          <div className="bg-neutral-900/50 border border-zinc-700 rounded-lg p-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {errors.accountType && <p className="text-red-400 text-sm">{errors.accountType}</p>}
              </div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="w-4 h-4 text-red-600 bg-neutral-700 border-gray-600 rounded focus:ring-red-500"
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-neutral-900/95 backdrop-blur-sm border-t border-zinc-700 p-4">
        <div className="max-w-2xl mx-auto flex justify-center">
          <Button 
            ...
            className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 text-lg font-semibold transition-all duration-200 hover:scale-105 shadow-lg shadow-red-600/25"
          >
            Submit Registration (Vanilla)
          </Button>
        </div>
      </div>
    </div>
